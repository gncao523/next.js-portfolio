import avatar from "../../assets/kira.png";
...
const Hero = () => {
  ...
  //             <img className="h-10 w-10 rounded-full" src={FantasyImg} alt="" />
  //           </div>
    ...
    >
      ...
      >
        <motion.img
          ...
          src={avatar}
          alt="avatar"
          className="w-48 h-48 md:w-52 md:h-52 xl:w-60 xl:h-60 object-cover bg-gradient-to-b from-amber-500 to-amber-700 rounded-3xl shadow-lg shadow-gray-400/30 dark:shadow-black/30 pointer-events-none"
        />
        {/* <motion.div
      ...
      <motion.h2
        ...
        className="text-sm pt-3 md:text-2xl text-amber-500 font-bold z-0"
      >
        Shopify Developer
      </motion.h2>
      ...
      <motion.div
        ...
        animate={animation.show}
        transition={{ delay: 0.5 }}
        className="py-3 text-xl md:text-2xl lg:text-3xl text-center font-bold leading-[1] z-0"
      >
        <span className="text-slate-700 dark:text-slate-200">
          <TypeAnimation
            sequence={[
              "Welcome👋",
              2000,
              "My Name is Pham Van Huy.",
              2000,
              "Guy-Who-Loves-Shopify",
              2000,
              "Guy-Who-Loves-Fullstack",
              2000,
            ]}
            speed={30}
            wrapper="span"
